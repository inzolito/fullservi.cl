...
<tr>
		<td colspan="7" align="center"> <h4>Listado De Productos </h4></td>
...
<table class=" display responsive  table table-striped table-bordered" id="tabla_productos">
		...
		<td><? echo $datos_producto["id_producto"] ?></td>	
			...
			<td>
				...
				<button type="button" class="btn btn-primary btn-xs" title="Registrar entrada"  onClick="modificar_stock(1,'<? echo $datos_producto["id_producto"] ?>')" id="btn_agregar_stock"><i class="fa fa-plus"> </i></button>
