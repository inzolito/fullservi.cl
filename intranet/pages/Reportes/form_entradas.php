...
$(document).ready(function(){
	...
	$("#sel_filtro_reporte_inout").change(function(){
	 ...
	 $("#btn_imprimir_inout").click(function(){
		 ...
		 reporte_salidas($("#sel_tipo_reporte").val(), $("#sel_filtro_reporte_inout").val(), $("#date_inicio").val() ,$("#date_fin").val(), $("#date_dia").val() , $("#date_mes").val(), $("#sel_filtro_ano").val() )
...
<div class="modal-header">
    ...
    <h4 class="modal-title">ENTRADAS Y SALIDAS DE PRODUCTO</h4>
</div>
<div class="modal-body">
  ...
  <div class="panel panel-default">
	  <div class="panel-body"> 
	  	...
	  	<div class="row">
	  	<div class="col-md-12">
        <label for="sel_tipo_reporte">Tipo de reporte</label>
	  	<select id="sel_tipo_reporte" name="sel_tipo_reporte" class="form-control" >
